...
var LookupTexture3D = class extends DataTexture3D {
  constructor(data, size) {
    ...
    this.minFilter = LinearFilter7;
    this.magFilter = LinearFilter7;
  ...
  convertLinearToSRGB() {
    ...
    if (this.type === FloatType2) {
      const stride = this.format === RGBAFormat4 ? 4 : 3;
  ...
  toDataTexture() {
    ...
    texture.minFilter = LinearFilter7;
    texture.magFilter = LinearFilter7;
...
var LUTEffect = class extends Effect {
  ...
  configureTetrahedralInterpolation() {
    const lut = this.getLUT();
    lut.minFilter = LinearFilter8;
    lut.magFilter = LinearFilter8;
...
var SelectiveBloomEffect = class extends BloomEffect {
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    if (!alpha && frameBufferType === UnsignedByteType10) {
      this.renderTargetSelection.texture.format = RGBFormat12;
    }
    if (frameBufferType !== void 0) {
...
var SMAAEffect = class extends Effect {
  constructor(searchImage, areaImage, preset = SMAAPreset.HIGH, edgeDetectionMode = EdgeDetectionMode.COLOR) {
    ...
    this.renderTargetWeights.texture.format = RGBAFormat5;
    ...
    searchTexture.format = RGBAFormat5;
    searchTexture.generateMipmaps = false;
    searchTexture.needsUpdate = true;
    searchTexture.flipY = true;
    const areaTexture = new Texture(areaImage);
    areaTexture.name = "SMAA.Area";
    areaTexture.minFilter = LinearFilter11;
    areaTexture.format = RGBAFormat5;
...
import {FileLoader as FileLoader2, Loader as Loader2, LoadingManager as LoadingManager2, sRGBEncoding as sRGBEncoding5, Vector3 as Vector36} from "three";
