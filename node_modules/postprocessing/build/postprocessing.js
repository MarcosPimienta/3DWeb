...
var POSTPROCESSING = (() => {
  ...
  // src/images/textures/LookupTexture3D.js
  var c = new import_three43.Color();
  var LookupTexture3D = class extends import_three43.DataTexture3D {
    constructor(data, size) {
      super(data, size, size, size);
      this.type = import_three43.FloatType;
      this.format = import_three43.RGBFormat;
      this.encoding = import_three43.LinearEncoding;
      this.minFilter = import_three43.LinearFilter;
      this.magFilter = import_three43.LinearFilter;
      this.wrapS = import_three43.ClampToEdgeWrapping;
      this.wrapT = import_three43.ClampToEdgeWrapping;
      this.wrapR = import_three43.ClampToEdgeWrapping;
      this.unpackAlignment = 1;
      this.domainMin = new import_three43.Vector3(0, 0, 0);
      this.domainMax = new import_three43.Vector3(1, 1, 1);
    }
    ...
    applyLUT(lut) {
      ...
      } else if (lut.type !== import_three43.FloatType || this.type !== import_three43.FloatType) {
        console.error("Both LUTs must be FloatType textures");
      } else if (lut.format !== import_three43.RGBFormat || this.format !== import_three43.RGBFormat) {
    ...
    convertToUint8() {
      if (this.type === import_three43.FloatType) {
        ...
        this.type = import_three43.UnsignedByteType;
        this.needsUpdate = true;
      }
      return this;
    }
    convertToFloat() {
      if (this.type === import_three43.UnsignedByteType) {
    ...
    convertLinearToSRGB() {
      ...
      if (this.type === import_three43.FloatType) {
        const stride = this.format === import_three43.RGBAFormat ? 4 : 3;
        for (let i = 0, l = data.length; i < l; i += stride) {
          c.fromArray(data, i).convertLinearToSRGB().toArray(data, i);
        }
        this.encoding = import_three43.sRGBEncoding;
        this.needsUpdate = true;
      } else {
    ...
    convertToRGBA() {
      if (this.format === import_three43.RGBFormat) {
        ...
        this.format = import_three43.RGBAFormat;
        this.needsUpdate = true;
      }
      return this;
    }
    toDataTexture() {
      ...
      const texture = new import_three43.DataTexture(this.image.data, width, height);
      texture.name = this.name;
      texture.type = this.type;
      texture.format = this.format;
      texture.encoding = this.encoding;
      texture.minFilter = import_three43.LinearFilter;
      texture.magFilter = import_three43.LinearFilter;
  ...
  var LUTEffect = class extends Effect {
    constructor(lut, {
      ...
      super("LUTEffect", shader_default59, {
        blendFunction,
        uniforms: new Map([
          ["lut", new import_three44.Uniform(null)],
          ["scale", new import_three44.Uniform(new import_three44.Vector3())],
          ["offset", new import_three44.Uniform(new import_three44.Vector3())],
          ["domainMin", new import_three44.Uniform(null)],
          ["domainMax", new import_three44.Uniform(null)]
        ])
      });
      this.tetrahedralInterpolation = tetrahedralInterpolation;
      this.inputEncoding = import_three44.sRGBEncoding;
      this.outputEncoding = this.inputEncoding;
      this.setInputEncoding(import_three44.sRGBEncoding);
      this.setLUT(lut);
    }
    getOutputEncoding() {
    ...
    setInputEncoding(value) {
      ...
      switch (value) {
        case import_three44.sRGBEncoding:
          defines.set("linearToInputTexel(texel)", "LinearTosRGB(texel)");
          break;
        case import_three44.LinearEncoding:
      ...
      if (lut !== null) {
        this.outputEncoding = lut.encoding === import_three44.LinearEncoding ? value : lut.encoding;
    ...
    setLUT(lut) {
      ...
      if (this.getLUT() !== lut) {
        ...
        if (lut.type === import_three44.FloatType || lut.type === import_three44.HalfFloatType) {
          defines.set("LUT_PRECISION_HIGH", "1");
        }
        if (image.width > image.height) {
          defines.set("LUT_STRIP_HORIZONTAL", "1");
        } else if (lut instanceof import_three44.DataTexture3D) {
    ...
    configureTetrahedralInterpolation() {
      const lut = this.getLUT();
      lut.minFilter = import_three44.LinearFilter;
      lut.magFilter = import_three44.LinearFilter;
      this.defines.delete("TETRAHEDRAL_INTERPOLATION");
      if (this.tetrahedralInterpolation && lut !== null) {
        if (lut instanceof import_three44.DataTexture3D) {
          this.defines.set("TETRAHEDRAL_INTERPOLATION", "1");
          lut.minFilter = import_three44.NearestFilter;
          lut.magFilter = import_three44.NearestFilter;
        } else {
  ...
  var OutlineEffect = class extends Effect {
    constructor(scene, camera, {
      ...
      super("OutlineEffect", shader_default61, {
        uniforms: new Map([
          ...
          ["patternScale", new import_three45.Uniform(1)],
      ...
      this.renderTargetMask = new import_three45.WebGLRenderTarget(1, 1, {
        minFilter: import_three45.LinearFilter,
        magFilter: import_three45.LinearFilter,
        stencilBuffer: false,
        format: import_three45.RGBFormat
      });
    ...
    setPatternTexture(texture) {
      if (texture !== null) {
        texture.wrapS = texture.wrapT = import_three45.RepeatWrapping;
    ...
    constructor(granularity = 30) {
      super("PixelationEffect", shader_default63, {
        uniforms: new Map([
          ...
          ["d", new import_three46.Uniform(new import_three46.Vector2())]
        ])
      });
  ...
  var v2 = new import_three49.Vector3();
  var ab = new import_three49.Vector3();
  var ShockWaveEffect = class extends Effect {
    constructor(camera, epicenter = new import_three49.Vector3(), {
      speed = 2,
      maxRadius = 1,
      waveSize = 0.2,
      amplitude = 0.05
  ...
  var SelectiveBloomEffect = class extends BloomEffect {
    constructor(scene, camera, options) {
      ...
      this.blackoutPass = new RenderPass(scene, camera, new import_three50.MeshBasicMaterial({color: 0}));
      this.blackoutPass.clear = false;
      this.backgroundPass = (() => {
        const backgroundScene = new import_three50.Scene();
        const pass = new RenderPass(backgroundScene, camera);
        backgroundScene.background = scene.background;
        pass.clear = false;
        return pass;
      })();
      this.renderTargetSelection = new import_three50.WebGLRenderTarget(1, 1, {
        minFilter: import_three50.LinearFilter,
        magFilter: import_three50.LinearFilter,
        stencilBuffer: false,
        depthBuffer: true
      });
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (!alpha && frameBufferType === import_three50.UnsignedByteType) {
        this.renderTargetSelection.texture.format = import_three50.RGBFormat;
      }
      if (frameBufferType !== void 0) {
  ...
  var SepiaEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, intensity = 1} = {}) {
      super("SepiaEffect", shader_default68, {
        blendFunction,
        uniforms: new Map([
          ["intensity", new import_three51.Uniform(intensity)]
        ])
      });
    }
  };
  ...
  var SMAAEffect = class extends Effect {
    constructor(searchImage, areaImage, preset = SMAAPreset.HIGH, edgeDetectionMode = EdgeDetectionMode.COLOR) {
      super("SMAAEffect", shader_default69, {
        ...
        attributes: EffectAttribute.CONVOLUTION | EffectAttribute.DEPTH,
        uniforms: new Map([
          ["weightMap", new import_three52.Uniform(null)]
        ])
      });
      this.renderTargetEdges = new import_three52.WebGLRenderTarget(1, 1, {
      ...
      this.renderTargetWeights.texture.format = import_three52.RGBAFormat;
      this.uniforms.get("weightMap").value = this.renderTargetWeights.texture;
      this.clearPass = new ClearPass(true, false, false);
      this.clearPass.overrideClearColor = new import_three52.Color(0);
      this.clearPass.overrideClearAlpha = 1;
      this.edgeDetectionPass = new ShaderPass(new EdgeDetectionMaterial(new import_three52.Vector2(), edgeDetectionMode));
      this.weightsPass = new ShaderPass(new SMAAWeightsMaterial());
      const searchTexture = new import_three52.Texture(searchImage);
      searchTexture.name = "SMAA.Search";
      searchTexture.magFilter = import_three52.NearestFilter;
      searchTexture.minFilter = import_three52.NearestFilter;
      searchTexture.format = import_three52.RGBAFormat;
      searchTexture.generateMipmaps = false;
      searchTexture.needsUpdate = true;
      searchTexture.flipY = true;
      const areaTexture = new import_three52.Texture(areaImage);
      areaTexture.name = "SMAA.Area";
      areaTexture.minFilter = import_three52.LinearFilter;
      areaTexture.format = import_three52.RGBAFormat;
  ...
  var SSAOEffect = class extends Effect {
    constructor(camera, normalBuffer, {
      ...
      super("SSAOEffect", shader_default71, {
        ...
        attributes: EffectAttribute.DEPTH,
        uniforms: new Map([
          ["aoBuffer", new import_three53.Uniform(null)],
          ["normalDepthBuffer", new import_three53.Uniform(null)],
          ["luminanceInfluence", new import_three53.Uniform(luminanceInfluence)],
          ["color", new import_three53.Uniform(null)],
          ["scale", new import_three53.Uniform(0)]
        ])
      });
      this.renderTargetAO = new import_three53.WebGLRenderTarget(1, 1, {
      ...
      this.ssaoPass = new ShaderPass((() => {
        ...
        noiseTexture.wrapS = noiseTexture.wrapT = import_three53.RepeatWrapping;
    ...
    set color(value) {
      ...
      if (value !== null) {
        if (defines.has("COLORIZE")) {
          ...
          uniforms.get("color").value = new import_three53.Color(value);
          this.setChanged();
        }
  ...
  var TextureEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, texture = null, aspectCorrection = false} = {}) {
      super("TextureEffect", shader_default72, {
        ...
        uniforms: new Map([
          ["texture", new import_three54.Uniform(null)],
          ["scale", new import_three54.Uniform(1)],
          ["uvTransform", new import_three54.Uniform(null)]
        ])
      });
      ...
      if (currentTexture !== value) {
        ...
        if (value !== null) {
          switch (value.encoding) {
            case import_three54.sRGBEncoding:
              this.defines.set("texelToLinear(texel)", "sRGBToLinear(texel)");
              break;
            case import_three54.LinearEncoding:
    ...
    set uvTransform(value) {
      if (this.uvTransform !== value) {
        if (value) {
          ...
          this.uniforms.get("uvTransform").value = new import_three54.Matrix3();
          this.setVertexShader(shader_default73);
        } else {
  ...
  var ToneMappingEffect = class extends Effect {
    constructor({
      ...
      super("ToneMappingEffect", shader_default74, {
        blendFunction,
        uniforms: new Map([
          ["luminanceBuffer", new import_three55.Uniform(null)],
          ["maxLuminance", new import_three55.Uniform(maxLuminance)],
          ["whitePoint", new import_three55.Uniform(whitePoint)],
          ["middleGrey", new import_three55.Uniform(middleGrey)],
          ["averageLuminance", new import_three55.Uniform(averageLuminance)]
        ])
      });
      this.renderTargetLuminance = new import_three55.WebGLRenderTarget(1, 1, {
        minFilter: import_three55.LinearMipmapLinearFilter !== void 0 ? import_three55.LinearMipmapLinearFilter : import_three55.LinearMipMapLinearFilter,
  ...
  var VignetteEffect = class extends Effect {
    constructor(options = {}) {
      ...
      super("VignetteEffect", shader_default75, {
        ...
        uniforms: new Map([
          ["offset", new import_three56.Uniform(settings.offset)],
          ["darkness", new import_three56.Uniform(settings.darkness)]
        ])
      });
